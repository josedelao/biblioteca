...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset("assets/$theme/dist/css/font.css")?family=Source+Sans+Pro:300,400,400i,700&display=fallback}}" />
        <!-- Font Awesome -->
        <link rel="stylesheet" href="{{asset("asset/$theme/plugins/fontawesome-free/css/all.min.css")}}" />
        <!-- Theme style -->
